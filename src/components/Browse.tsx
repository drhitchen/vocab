...
export default function Browse({ words, cards }: BrowseProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-6">
      ...
      <div className="border border-slate-800 rounded-lg overflow-hidden">
        {/* Header row */}
        <div className="grid grid-cols-[2rem_1fr_auto_auto_2fr] gap-3 px-4 py-2 bg-slate-800 text-xs text-slate-400 uppercase tracking-wide">
          <span />
          <span>Word</span>
          <span>POS</span>
          <span>Type</span>
